    ...
    <div className='flex min-h-screen items-center justify-center'>
      <div className='mx-auto flex w-full flex-col justify-center space-y-6 sm:w-[350px]'>
        ...
        <form
          action={async (formData) => {
            ...
            await signIn('credentials', {
              ...
              redirectTo: getI18nPath('/dashboard', props.params.locale),
            })
          }}
        ...
        <div className='grid grid-cols-2 gap-4'>
          <button
            onClick={() =>
              signIn('google', { callbackUrl: getI18nPath('/dashboard', props.params.locale) })
            }
            className='inline-flex items-center justify-center whitespace-nowrap rounded-md border border-input bg-background hover:bg-accent hover:text-accent-foreground h-10 px-4 py-2 w-full'
          >
          ...
          <button
            onClick={() =>
              signIn('github', { callbackUrl: getI18nPath('/dashboard', props.params.locale) })
            }
            className='inline-flex items-center justify-center whitespace-nowrap rounded-md border border-input bg-background hover:bg-accent hover:text-accent-foreground h-10 px-4 py-2 w-full'
          >
