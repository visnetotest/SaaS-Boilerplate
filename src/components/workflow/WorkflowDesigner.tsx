...
import { Workflow, WorkflowStep, Connection } from '../../types/workflow-local';
        ...
        <div className="flex items-center space-x-2">
          ...
          <div className="flex items-center space-x-1">
            <button
              ...
              onClick={() => setCanvasState(prev => ({ ...prev, scale: Math.min(prev.scale * 1.2, 5) }))}
            >
              🔍+
            </button>
            ...
            <button
              className="p-2 bg-gray-100 rounded hover:bg-gray-200"
              onClick={() => setCanvasState(prev => ({ ...prev, scale: Math.max(prev.scale * 0.8, 0.2) }))}
            >
              🔍-
            </button>
          </div>
...
/>
          ...
          {canvasState.steps.map(step => {
            ...
            return (
              ...
              >
                <div className={`bg-white rounded-lg border-2 p-4 h-full flex items-center ${isSelected ? 'border-blue-500' : 'border-gray-300'}`}>
                  <div 
