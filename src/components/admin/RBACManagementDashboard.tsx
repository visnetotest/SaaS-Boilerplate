...
function CreateRoleDialog({ 
  ...
  const availablePermissions = permissions.filter(p => 
    !form.watch('permissions')?.includes(p.id)
  )
...
export function RBACManagementDashboard() {
  ...
  const [roles] = useState<Role[]>([
    {
      ...
      tenantName: 'System',
      permissions: [
        { id: '1', name: 'All Access', resource: '*', action: '*', category: 'system', createdAt: '2024-01-01' },
      ],
      isSystem: true,
      userCount: 2,
    ...
    },
    {
      ...
      permissions: [
        { id: '2', name: 'Manage Users', resource: 'users', action: '*', category: 'users', createdAt: '2024-01-05' },
        { id: '3', name: 'Manage Billing', resource: 'billing', action: '*', category: 'billing', createdAt: '2024-01-05' },
      ],
      isSystem: false,
      userCount: 5,
    ...
    },
    {
      ...
      tenantName: 'Acme Corp',
      permissions: [
        { id: '4', name: 'View Users', resource: 'users', action: 'read', category: 'users', createdAt: '2024-01-10' },
        { id: '5', name: 'View Reports', resource: 'reports', action: 'read', category: 'reports', createdAt: '2024-01-10' },
      ],
      isSystem: false,
      userCount: 15,
  ...
  const [permissions] = useState<Permission[]>([
    ...
    { id: '4', name: 'View Users', resource: 'users', action: 'read', category: 'users', createdAt: '2024-01-10' },
    { id: '5', name: 'View Reports', resource: 'reports', action: 'read', category: 'reports', createdAt: '2024-01-10' },
    { id: '6', name: 'Create Content', resource: 'content', action: 'create', category: 'content', createdAt: '2024-01-15' },
    { id: '7', name: 'Edit Content', resource: 'content', action: 'update', category: 'content', createdAt: '2024-01-15' },
    { id: '8', name: 'Delete Content', resource: 'content', action: 'delete', category: 'content', createdAt: '2024-01-15' },
  ])
  ...
  const [userAssignments] = useState<UserRoleAssignment[]>([
    {
      ...
      roles: [
        { id: '2', name: 'Tenant Admin', tenantId: '2', tenantName: 'Acme Corp', permissions: [], isSystem: false, userCount: 0, createdAt: '2024-01-05' },
      ],
    },
    {
      userId: '2',
      ...
      roles: [
        { id: '3', name: 'Viewer', tenantId: '2', tenantName: 'Acme Corp', permissions: [], isSystem: false, userCount: 0, createdAt: '2024-01-10' },
      ],
    },
  ])
    ...
    <div className="space-y-6">
      ...
      {activeTab === 'roles' && (
        <div>
          <div className="mb-4">
            <p className="text-sm text-muted-foreground">
              Manage roles and their associated permissions. Roles define what users can do within the system.
            </p>
          </div>
      ...
      {activeTab === 'permissions' && (
        <div>
          <div className="mb-4">
            <p className="text-sm text-muted-foreground">
              Manage system permissions. Permissions are the building blocks that define what actions can be performed on resources.
            </p>
          </div>
      ...
      {activeTab === 'assignments' && (
        <div>
          <div className="mb-4">
            <p className="text-sm text-muted-foreground">
              View and manage user role assignments. Users can have multiple roles across different tenants.
            </p>
          </div>
          <Card>
            <CardHeader>
            ...
            <CardContent>
              <div className="space-y-4">
                {userAssignments.map((assignment) => (
                  <div key={assignment.userId} className="flex items-center justify-between p-4 border rounded-lg">
                    <div>
