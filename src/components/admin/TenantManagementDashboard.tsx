    ...
    <div className='fixed inset-0 z-50 flex items-center justify-center'>
      ...
      <div className='relative z-50 w-full max-w-lg rounded-lg border bg-background p-6 shadow-lg'>
        <div className='flex flex-col space-y-1.5 text-center sm:text-left'>
          <h2 className='text-lg font-semibold leading-none tracking-tight'>Create New Tenant</h2>
          ...
          <div className='space-y-4'>
            <div className='grid grid-cols-1 md:grid-cols-2 gap-4'>
              <div>
                ...
                <Input placeholder='Enter tenant name' {...form.register('name')} />
              ...
              <div>
                ...
                <Input placeholder='tenant-slug' {...form.register('slug')} />
            ...
            <div>
              ...
              <Input type='url' placeholder='https://example.com' {...form.register('domain')} />
            ...
            <div className='grid grid-cols-1 md:grid-cols-2 gap-4'>
              <div>
                ...
                {form.formState.errors.plan && (
                  <p className='text-sm text-red-500'>{form.formState.errors.plan.message}</p>
                )}
              </div>
  ...
  return (
    <div className='space-y-6'>
      <div className='flex items-center justify-between'>
        ...
        <Button onClick={() => setShowCreateDialog(true)}>Add Tenant</Button>
      </div>
          ...
          <Card key={tenant.id} className='relative'>
            ...
            <CardContent>
              <div className='space-y-3'>
                ...
                {tenant.domain && (
                  <div className='text-sm text-muted-foreground truncate'>{tenant.domain}</div>
                )}
                ...
                <div className='flex items-center justify-between'>
                  ...
                  <div className='text-sm text-muted-foreground'>{tenant.userCount} users</div>
                </div>
